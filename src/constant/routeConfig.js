{
    "routes": [
        {
            "sourceRoute": "/interface/v1/tracking/assessment/read/:assessmentTrackingId",
            "type": "POST",
            "priority": "MUST_HAVE",
            "inSequence": false,
            "orchestrated": false,
        ...
        {
            "sourceRoute": "/interface/v1/tracking/assessment/delete/:assessmentTrackingId",
            "type": "POST",
            "priority": "MUST_HAVE",
            "inSequence": false,
            "orchestrated": false,
        ...
        {
            "sourceRoute": "/interface/v1/tracking/ai-assessment/update-status/:identifier",
            "type": "PATCH",
            "priority": "MUST_HAVE",
            "inSequence": false,
            "orchestrated": false,
        ...
        {
            "sourceRoute": "/interface/v1/tracking/answer-sheet-submissions/update-status/:identifier",
            "type": "PATCH",
            "priority": "MUST_HAVE",
            "inSequence": false,
            "orchestrated": false,
        ...
        {
            "sourceRoute": "/interface/v1/tracking/answer-sheet-submissions/read/:identifier",
            "type": "GET",
            "priority": "MUST_HAVE",
            "inSequence": false,
            "orchestrated": false,
